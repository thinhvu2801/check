<?php /* Smarty version Smarty-3.1.16, created on 2024-03-14 07:09:41
         compiled from "D:\xampp\htdocs\htdocsbentre\application\views\product\index.php" */ ?>
<?php /*%%SmartyHeaderCode:134578570365bb25d9c08e04-76669017%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6c86e490eb371e8b7333ef017bd0aa6193472dc' => 
    array (
      0 => 'D:\\xampp\\htdocs\\htdocsbentre\\application\\views\\product\\index.php',
      1 => 1710396561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134578570365bb25d9c08e04-76669017',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_65bb25d9c70343_39171538',
  'variables' => 
  array (
    'base_url' => 0,
    'parent_id' => 0,
...
<?php if ($_valid && !is_callable('content_65bb25d9c70343_39171538')) {function content_65bb25d9c70343_39171538($_smarty_tpl) {?><div class="row">
  <div class="col-md-3">
...
">
        <div class="card-body">
          ...
          <div class="form-group">
            <label>Tính định mức</label>
            <select class="form-control select2" style="width: 100%;" name="dinhmuc">
              <option value="0" selected="selected">Không</option>
              <option value="1">Có</option>
            </select>
          </div>
...
">
          ...
          <div class="form-group row">
            <label for="linkable" class="col-sm-4 col-form-label">Tính định mức</label>
            <div class="col-sm-8">
              <select class="form-control select2" style="width: 100%;" id="dinhmuc" name="dinhmuc">
                <option value="0" selected="selected" <?php if ($_smarty_tpl->tpl_vars['pr']->value->dinhmuc==0) {?>selected<?php }?>>Không</option>
                <option value="1" <?php if ($_smarty_tpl->tpl_vars['pr']->value->dinhmuc==1) {?>selected<?php }?>>Có</option>
              </select>
            </div>
          </div>
        </div>
