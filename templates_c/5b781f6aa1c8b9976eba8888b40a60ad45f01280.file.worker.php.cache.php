<?php /* Smarty version Smarty-3.1.16, created on 2024-03-01 02:16:38
         compiled from "D:\xampp\htdocs\htdocsbentre\application\views\statistic\suaca\worker.php" */ ?>
<?php /*%%SmartyHeaderCode:59845994765d2fc15f01376-27095107%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b781f6aa1c8b9976eba8888b40a60ad45f01280' => 
    array (
      0 => 'D:\\xampp\\htdocs\\htdocsbentre\\application\\views\\statistic\\suaca\\worker.php',
      1 => 1709255718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '59845994765d2fc15f01376-27095107',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_65d2fc160459b1_34053686',
  'variables' => 
  array (
    'base_url' => 0,
    'lohang' => 0,
...
<?php if ($_valid && !is_callable('content_65d2fc160459b1_34053686')) {function content_65d2fc160459b1_34053686($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\htdocsbentre\\application\\third_party\\Smarty-3.1.16\\libs\\plugins\\modifier.date_format.php';
?><div class="row">
    <div class="col-md-3">
...
suaca/worker" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
...
threshold">Định mức chuẩn </a> để phân loại đậu, rớt định mức</span>
                    <!-- <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" name="weight_in" value="<?php echo $_smarty_tpl->tpl_vars['weight_in']->value;?>
" step="0.001" class="form-control"> 
                        </div> 
                        <span>Cài đặt <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
threshold/suaca_read">Định mức chuẩn </a> để phân loại đậu, rớt định mức</span>
                    </div>-->
                </div>
                <!-- /.card-body -->
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr style="font-weight: bold;" align="center">
                            ...
                            <td>Công nhân</td>
                            <td>Sản phẩm</td>
                            <td width="7%">&sum;SL vào</td>
                            <td width="7%">&sum;SL ra</td>
                    ...
                    <tbody>
                        ...
                        <?php $_smarty_tpl->tpl_vars['so_luong_vao'] = new Smarty_variable(0, null, 0);?>
                        <?php $_smarty_tpl->tpl_vars['so_luong_ra'] = new Smarty_variable(0, null, 0);?>
...
?>
                        <?php $_smarty_tpl->tpl_vars['so_luong_vao'] = new Smarty_variable($_smarty_tpl->tpl_vars['so_luong_vao']->value+$_smarty_tpl->tpl_vars['rs']->value['so_luong_vao'], null, 0);?>
                        <?php $_smarty_tpl->tpl_vars['so_luong_ra'] = new Smarty_variable($_smarty_tpl->tpl_vars['so_luong_ra']->value+$_smarty_tpl->tpl_vars['rs']->value['so_luong_ra'], null, 0);?>
                        ...
                        <tr>
                            ...
                            <td align="right"><?php echo $_smarty_tpl->tpl_vars['rs']->value['so_luong_vao'];?>
</td>
                            <td align="right"><?php echo $_smarty_tpl->tpl_vars['rs']->value['so_luong_ra'];?>
</td>
                    ...
                    <tfoot>
                        <tr align="right" style="font-weight: bold;">
                            ...
                            <td align="right"><?php echo number_format($_smarty_tpl->tpl_vars['so_luong_vao']->value,0,",",".");?>
</td>
                            <td align="right"><?php echo number_format($_smarty_tpl->tpl_vars['so_luong_ra']->value,0,",",".");?>
</td>
                            ...
                            <td align="right">
                                <?php if ($_smarty_tpl->tpl_vars['khoi_luong_ra']->value!=0) {?>
                                <?php echo number_format(($_smarty_tpl->tpl_vars['khoi_luong_vao']->value/$_smarty_tpl->tpl_vars['khoi_luong_ra']->value),3,",",".");?>
