<?php /* Smarty version Smarty-3.1.16, created on 2024-07-22 11:05:03
         compiled from "D:\xampp\htdocs\htdocsbentre\application\views\statistic\suaca\worker_total.php" */ ?>
<?php /*%%SmartyHeaderCode:157181063669e2092713c50-79140757%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cef141b0a1827a215b406013143c2e8653372c5' => 
    array (
      0 => 'D:\\xampp\\htdocs\\htdocsbentre\\application\\views\\statistic\\suaca\\worker_total.php',
      1 => 1721639101,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157181063669e2092713c50-79140757',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_669e20927e6e83_42147934',
  'variables' => 
  array (
    'base_url' => 0,
    'lohang' => 0,
...
<?php if ($_valid && !is_callable('content_669e20927e6e83_42147934')) {function content_669e20927e6e83_42147934($_smarty_tpl) {?><div class="row">
    <div class="col-md-3">
...
suaca/worker_total" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
...
" <?php if ($_smarty_tpl->tpl_vars['lo_id']->value==$_smarty_tpl->tpl_vars['lo']->value->lo_id) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['lo']->value->lo_id;?>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Sản phẩm</i></span>
                            </div>
...
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['p']->value->product_id;?>
" <?php if ($_smarty_tpl->tpl_vars['product_id']->value==$_smarty_tpl->tpl_vars['p']->value->product_id) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['p']->value->product_name;?>
</option>
                                <?php } ?>
                            </select>
                        </div>
