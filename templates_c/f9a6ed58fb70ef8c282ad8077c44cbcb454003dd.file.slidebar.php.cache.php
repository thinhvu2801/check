<?php /* Smarty version Smarty-3.1.16, created on 2025-06-26 04:14:38
         compiled from "D:\App\Wampp\www\check\application\views\slidebar.php" */ ?>
<?php /*%%SmartyHeaderCode:3400935886858bf923e9794-69353920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9a6ed58fb70ef8c282ad8077c44cbcb454003dd' => 
    array (
      0 => 'D:\\App\\Wampp\\www\\check\\application\\views\\slidebar.php',
      1 => 1750911274,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3400935886858bf923e9794-69353920',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_6858bf9324ec83_68094071',
  'variables' => 
  array (
    'base_url' => 0,
    'hoten' => 0,
...
<?php if ($_valid && !is_callable('content_6858bf9324ec83_68094071')) {function content_6858bf9324ec83_68094071($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include 'D:\\App\\Wampp\\www\\check\\application\\third_party\\Smarty-3.1.16\\libs\\plugins\\modifier.in_array.php';
...
fillet/worker" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_fillet_worker') {?>active<?php }?>">
                          ...
                          <?php }?>
                            ...
                            <?php if (smarty_modifier_in_array('stat_fillet_worker_sl',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                            <li class="nav-item">
                                <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
fillet/workersl" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_fillet_worker_sl') {?>active<?php }?>">
                                    <i class="fa fa-angle-right nav-icon"></i>
...
fillet/over_threshold" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_fillet_over_threshold') {?>active<?php }?>">
                          ...
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_fillet_worker_over_threshold',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
fillet/worker_over_threshold" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_fillet_worker_over_threshold') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>CN bất thường</p>
                              </a>
                          </li>
...
fillet/xuatban" class="nav-link">
                  ...
                  <!-- <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['truck'];?>
">
                      <a href="#" class="nav-link">
                          <i class="nav-icon fas fa-chart-pie"></i>
                          <p>
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('stat_truck_detail2',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
truck/detail2" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_truck_detail2') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Chi tiết</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_truck_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
truck/detail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_truck_detail') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Tổng hợp</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_truck_customer',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
truck/customer" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_truck_customer') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Theo Khách hàng</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_truck_detail_history',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
truck/detailhistory" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_truck_detail_history') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Lịch sử cân</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_truck_weight_out',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
truck/weightout" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_truck_weight_out') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                  ...
                  <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['baotubongbong'];?>
">
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('stat_baotubongbong_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
baotubongbong/detail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_baotubongbong_detail') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Chi tiết</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_baotubongbong_product',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
baotubongbong/product" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_baotubongbong_product') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Sản phẩm</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_baotubongbong_worker',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
baotubongbong/worker" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_baotubongbong_worker') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Công nhân</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('stat_baotubongbong_detail_edit',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
baotubongbong/detail_edit" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_baotubongbong_detail_edit') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Chỉnh sửa</p>
                              </a>
                          </li>
                  ...
                  <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['dauxuong'];?>
">
                      <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
baotubongbong/dauxuong" class="nav-link">
                          <i class="nav-icon fas fa-chart-pie"></i>
                          <p>
                              Đầu - Xương
                          </p>
                  ...
                  <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['rutchi'];?>
">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if (smarty_modifier_in_array('stat_rutchi_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/rutchidetail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_rutchi_detail') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Chi tiết</p>
                            </a>
                        </li>
                        <?php }?>
                        <?php if (smarty_modifier_in_array('stat_rutchi_worker',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/rutchiworker" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_rutchi_worker') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Công nhân</p>
                            </a>
                        </li>
                  ...
                  <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['catbtp'];?>
">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if (smarty_modifier_in_array('stat_catbtp_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/catbtpdetail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_catbtp_detail') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Chi tiết</p>
                            </a>
                        </li>
                        <?php }?>
                        <?php if (smarty_modifier_in_array('stat_catbtp_worker',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/catbtpworker" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_catbtp_worker') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Công nhân</p>
                            </a>
                        </li>
                  ...
                  <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['btpngam'];?>
">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if (smarty_modifier_in_array('stat_btpngam_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/btpngamdetail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_btpngam_detail') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Chi tiết</p>
                            </a>
                        </li>
                        <?php }?>
                        <?php if (smarty_modifier_in_array('stat_btpngam_no_input',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/btpngamnoinput" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_btpngam_no_input') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Không có đầu vào</p>
                            </a>
                        </li>
                        <?php }?>
                        <?php if (smarty_modifier_in_array('stat_btpngam_no_output',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                        <li class="nav-item">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/btpngamnooutput" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_btpngam_no_output') {?>active<?php }?>">
                                <i class="fa fa-angle-right nav-icon"></i>
                                <p>Chưa cân đầu ra</p>
                            </a>
                        </li>
                   ...
                   <li class="nav-item has-treeview <?php echo $_smarty_tpl->tpl_vars['menu_open']->value['biendongoverview'];?>
">
                      <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
tambot/overview" class="nav-link ">
                          <i class="nav-icon fas fa-chart-pie"></i>
                          <p>
                              Thống kê Tổng quan
                          </p>
...
warehouse/inventory" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='warehouse_inventory') {?>active<?php }?>">
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('warehouse_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
warehouse/detail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='warehouse_detail') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Chi tiết</p>
                              </a>
                          </li>
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('warehouse_total',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
warehouse/total" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='warehouse_total') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Tổng hợp</p>
                              </a>
                          </li>
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('warehouse_totalkho',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
warehouse/totalkho" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='warehouse_totalkho') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Tổng hợp kho</p>
                              </a>
                          </li>
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('warehouse_total_coi',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
warehouse/totalcoi" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='warehouse_total_coi') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
...
user/logout" class="nav-link">
                  ...
                  <li class="nav-item has-treeview">
                        <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
changedb/changedatabase" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='changedatabase') {?>active<?php }?>">
