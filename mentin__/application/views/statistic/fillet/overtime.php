<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}fillet/overtime" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            name="max_minute" id="max_minute" value="{$max_minute}">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <div class="form-group">
            ...
            <div class="card-body">
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="10%">{$rs.worker_id}</td>
                            <td>{$rs.worker_name}</td>
                            <td width="10%">{$rs.product_id}</td>
                            <td>{$rs.product_name}</td>
                            <td width="10%">{$rs.weight_in}</td>
                            <td width="10%">{$rs.weight_out}</td>
                            <td width="10%">{$rs.dinh_muc}</td>
                            <td width="10%">{$rs.time_in}</td>
                            <td width="10%">{$rs.time_out}</td>
                            <td width="10%">{$rs.time_finish}</td>
                        </tr>
                        {/foreach}
                    </tbody>
