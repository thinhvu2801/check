<div class="row">
    <div class="col-md-4">
        <div class="card card-info">
            ...
            <form action="{$base_url}statistic/canngheu_product" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="provider_id" id="provider_id">
                                ...
                                <option value="{$pr->provider_id}" {if $provider_id eq $pr->provider_id}selected{/if}>{$pr->provider_name}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="process_id" id="process_id">
                                ...
                                <option value="{$pr->process_id}" {if $process_id eq $pr->process_id}selected{/if}>{$pr->process_name}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
