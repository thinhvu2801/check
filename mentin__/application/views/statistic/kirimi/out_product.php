<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}statistic/kirimi_out_product" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{$rs.Product_in_name}</td>
                            <td align="center">{$rs.product_id_out}</td>
                            <td>{$rs.Product_out_name}</td>
