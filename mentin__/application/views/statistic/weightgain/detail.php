<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}weightgain/detail" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                    ...
                    <div class="form-group">
                        <div class="input-group">
                           ...
                           <input type="number" class="form-control"  name="coi_id" id="coi_id" value="{$coi_id}"/>
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <div class="input-group">
                    ...
                    <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">{$rs.date_data|date_format:"d/m/Y"}</td>
                                <td align="center">{$rs.date|date_format:"d/m/Y"}</td>
                                <td align="center">{$rs.me_id}</td>
                                <td align="center">{$rs.time}</td>
                                <td align="center">{$rs.quality_id}</td>
                                <td align="center">{$rs.size_id}</td>
