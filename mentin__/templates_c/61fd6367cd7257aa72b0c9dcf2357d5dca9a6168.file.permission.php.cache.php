<?php /* Smarty version Smarty-3.1.16, created on 2023-02-19 16:03:47
         compiled from "C:\xampp\htdocs\demo\application\views\user\permission.php" */ ?>
<?php /*%%SmartyHeaderCode:162006224063f23a53a97074-10898171%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61fd6367cd7257aa72b0c9dcf2357d5dca9a6168' => 
    array (
      0 => 'C:\\xampp\\htdocs\\demo\\application\\views\\user\\permission.php',
      1 => 1598865964,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162006224063f23a53a97074-10898171',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_63f23a53e120b6_72554063',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63f23a53e120b6_72554063')) {function content_63f23a53e120b6_72554063($_smarty_tpl) {?><!-- /.card -->
<div class="row">
  <div class="col-md-3">
...
user/insert" method="post">
        <div class="card-body">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" id="username" name="username" required maxlength="20" placeholder="Tài khoản" pattern="[A-Za-z0-9+-_]{3,}">
          </div>
           <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="Nhập lại mật khẩu" name="repassword" value="">
          </div>
          <!-- /input-group -->
        </div>
        <!-- /.card-body -->
