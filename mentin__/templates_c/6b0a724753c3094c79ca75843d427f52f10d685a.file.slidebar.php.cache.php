<?php /* Smarty version Smarty-3.1.16, created on 2023-03-02 13:49:55
         compiled from "C:\xampp\htdocs\demo\application\views\slidebar.php" */ ?>
<?php /*%%SmartyHeaderCode:111902462063e9df309345d4-03252574%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b0a724753c3094c79ca75843d427f52f10d685a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\demo\\application\\views\\slidebar.php',
      1 => 1677748933,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '111902462063e9df309345d4-03252574',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_63e9df30a02677_37153140',
  'variables' => 
  array (
    'base_url' => 0,
    'hoten' => 0,
...
<?php if ($_valid && !is_callable('content_63e9df30a02677_37153140')) {function content_63e9df30a02677_37153140($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include 'C:\\xampp\\htdocs\\demo\\application\\third_party\\Smarty-3.1.16\\libs\\plugins\\modifier.in_array.php';
...
">
                      ...
                      <ul class="nav nav-treeview">
                          <?php if (smarty_modifier_in_array('weightgain_stat_detail',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
weightgain/detail" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_weightgain_detail') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Chi tiết</p>
                              </a>
                          </li>
                          <?php }?>
                          <?php if (smarty_modifier_in_array('weightgain_stat_general',$_smarty_tpl->tpl_vars['role']->value,$_smarty_tpl->tpl_vars['admin']->value)) {?>
                          <li class="nav-item">
                              <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
weightgain/general" class="nav-link <?php if ($_smarty_tpl->tpl_vars['action']->value=='stat_weightgain_general') {?>active<?php }?>">
                                  <i class="fa fa-angle-right nav-icon"></i>
                                  <p>Tổng hợp</p>
                              </a>
                          </li>
