  ...
  <div class="col-md-7">
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        {foreach $coi as $m}
        <option value="{$m->coi_id}" {if $m->coi_id eq $coi_id} selected {/if}> {$m->coi_id}</option>
        {/foreach}
      </select>
      </div><!--card-body-->
    </div><!--card-info-->
