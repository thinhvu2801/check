      ...
      <form action="{$base_url}worker/insert" method="post">
        ...
        <div class="card-body">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" id="worker_id" name="worker_id" placeholder="Mã nhà máy" maxlength="20" {literal}pattern="[A-Za-z0-9-_]{3,}" {/literal}>
          </div>
          <!-- <div class="input-group mb-3">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <select class="form-control" name="factory_id" id="factory_id">
                ...
                {if !in_array($f->id, array_column($worker, 'factory_id'))}
          ...
          <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr align="center">
                <td>{$i++}</td>
                <td>{$wk->worker_id}</td>
                <td><a href="{$base_url}khothe/card/{$wk->factory_id}">{$wk->factory_id}</a></td>
                ...
                <td>
                <a href="{$base_url}worker/update_cn/{$wk->worker_id}/{$wk->status}/{$wk->group_id}">
                    {if $wk->status eq 1}
      ...
      <form class="form-horizontal" method="post" name="updateproduct" action="{$base_url}worker/update">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="factory_id" id="factory_id" value="{$wk->factory_id}" disabled>
              <select class="form-control group_product" style="width: 100%;" name="factory_id" id="rfid">
                  <option value="{$wk->factory_id}">{$wk->factory_id}</option>
                  {foreach $factory as $f}
