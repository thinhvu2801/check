  ...
  <div class="col-md-9">
    <div class="card card-info">
      ...
      <div class="card-footer">
        ...
        <!-- /.card-footer -->
        <form action="{$base_url}product/dongbo" method="post">
            <div class="form-group">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <select class="form-control select2" style="width: 100%;" id="dinhmuc" name="dinhmuc">
                <option value="0" selected="selected" {if $pr->dinhmuc eq 0}selected{/if}>Không</option>
                <option value="1" {if $pr->dinhmuc eq 1}selected{/if}>Có</option>
              </select>
            </div>
          </div>
        </div>
