<div class="row">
    <div class="col-md-3">
        <div class="card card-info" id="card_filter">
            ...
            <form action="{$base_url}xebuom/product" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">{$rs.dinhmuc|number_format:3:",":"."}</td>
                        </tr>
                        {/foreach}
                    </tbody>
                    <tfoot>
                        <tr align="right" style="font-weight: bold;">
                            ...
                            <td align="right">{$dinh_muc|number_format:3:",":"."}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
