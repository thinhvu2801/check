<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}suaca/worker" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                    ...
                    <!-- <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" name="weight_in" value="{$weight_in}" step="0.001" class="form-control"> 
                        </div> 
                        <span>Cài đặt <a href="{$base_url}threshold/suaca_read">Định mức chuẩn </a> để phân loại đậu, rớt định mức</span>
                    </div>-->
                </div>
                <!-- /.card-body -->
            ...
            <div class="card-body">
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        {$so_luong_vao = $so_luong_vao + $rs.so_luong_vao}
                        {$so_luong_ra = $so_luong_ra + $rs.so_luong_ra}
                        ...
                        <tr>
                            ...
                            <td align="right">{$rs.so_luong_vao}</td>
                            <td align="right">{$rs.so_luong_ra}</td>
                    ...
                    <tfoot>
                        <tr align="right" style="font-weight: bold;">
                            ...
                            <td align="right">{$so_luong_vao|number_format:0:",":"."}</td>
                            <td align="right">{$so_luong_ra|number_format:0:",":"."}</td>
                            <td align="right">{$khoi_luong_vao|number_format:3:",":"."}</td>
                            <td align="right">{$khoi_luong_ra|number_format:3:",":"."}</td>
                            <td align="right">
                                {if $khoi_luong_ra neq 0}
                                {($khoi_luong_vao/$khoi_luong_ra)|number_format:3:",":"."}
                                {/if}
                            </td>
                            <td align="right"></td>
                            <td align="right"></td>
