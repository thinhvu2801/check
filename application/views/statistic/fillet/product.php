<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}/fillet/product" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
    ...
    <div class="col-md-9">
        <div class="card card-info">
            <div class="card-header">
                ...
                <form action="{$base_url}fillet/product" method="post">
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                        <tr align="right" style="font-weight: bold;">
                            ...
                            <td align="right">{if $khoi_luong_ra neq 0}{($khoi_luong_vao/$khoi_luong_ra)|number_format:3:",":"."}{/if}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
