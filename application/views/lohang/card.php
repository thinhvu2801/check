  ...
  <div class="col-md-7">
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        <option value="{$lo->lo_id}" {if $lo->lo_id eq $lo_id} selected {/if}> {$lo->lo_id}</option>
        {/foreach}
      </select>
      </div><!--card-body-->
    </div><!--card-info-->
