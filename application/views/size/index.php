<div class="row">
  <div class="col-md-3">
    ...
    <div class="card card-info">
      ...
      <form action="{$base_url}size/import" method="post" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group">
            <div class="input-group">
            ...
            <div class="input-group">
              <a href="{$base_url}size.xls">Tải mẫu</a>
            </div>
...
<td>ghi chu</td>
      ...
      <div class="card-footer">
          <form action="{$base_url}size/dongbo" method="post">
            <div class="form-group">
