  ...
  <div class="col-md-7">
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        {foreach $xe as $pr}
          <option value="{$pr->xe_id}" {if $pr->xe_id eq $xe_id} selected {/if}>({$pr->xe_id}) {$pr->xe_name}</option>
        {/foreach}
        </select>
      </div><!--card-body-->
    </div><!--card-info-->
