...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    switch ($action) {
      ...
      case 'stat_fillet_worker_sl':
      case 'stat_fillet_invalid':
      case 'stat_fillet_over_threshold':
      case 'stat_fillet_worker_over_threshold':
      ...
      case 'stat_fillet_working':
        ...
        break;
      case 'stat_xebuom_detailin':
      case 'stat_xebuom_detailout':
      case 'stat_xebuom_product':
      case 'stat_xebuom_worker':
        SetMenuOpen($menu_open, "xebuom");
        break;
      case 'stat_baotubongbong_detail':
      case 'stat_baotubongbong_detail_edit':
      case 'stat_baotubongbong_product':
      case 'stat_baotubongbong_worker':
        SetMenuOpen($menu_open, "baotubongbong");
      
      case 'stat_baotubongbong_dauxuong':
        SetMenuOpen($menu_open, "dauxuong");
        break;
      case 'stat_truck_detail':
      case 'stat_truck_detail2':
      case 'stat_truck_detail_history':
      case 'stat_truck_weight_out':
      case 'stat_truck_customer':
        SetMenuOpen($menu_open, "truck");
        break;
      case 'stat_rutchi_detail':
      case 'stat_rutchi_worker':
        SetMenuOpen($menu_open, "rutchi");
        break;
      case 'stat_catbtp_detail':
      case 'stat_catbtp_worker':
        SetMenuOpen($menu_open, "catbtp");
        break;
      case 'stat_biendong_overview':
        SetMenuOpen($menu_open, "biendongoverview");
        break;
      case 'stat_btpngam_detail':
      case 'stat_btpngam_no_output':
      case 'stat_btpngam_no_input':
        SetMenuOpen($menu_open, "btpngam");
        break;
      case 'phu_pham_stat_detail':
      case 'phu_pham_stat_general':
        SetMenuOpen($menu_open, "phupham2");
        break;
      ...
      case 'saukiem_stat_chitiet':
      case 'saukiem_stat_product':
      ...
      case 'stat_machine':
        ...
        break;
      case 'warehouse_infor':
      case 'warehouse_inventory':
      case 'warehouse_out':
      case 'warehouse_in_history':
      case 'warehouse_out_history':
      case 'warehouse_reason_out':
      case 'warehouse_detail':
      case 'warehouse_total':
      case 'warehouse_totalkho':
        SetMenuOpen($menu_open, "warehouse");
        break;
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <?php
          if (isset($template)) {
              $view_data = isset($data) ? $data : [];
              $this->view->parse($template, $view_data);
          }
          ?>  
        </div><!-- /.container-fluid -->
      </section>
