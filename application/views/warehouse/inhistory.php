<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}warehouse/inhistory" method="post">
                <div class="card-body">
                    <!-- {if $mes neq ""}
        ...
        <div class="card card-info">
            ...
            <form action="{$base_url}warehouse/import" method="post" enctype="multipart/form-data">
                <div class="card-body">
                {if $mes neq ""}
                    <p class="mb-0" style="color: red;">{$mes}</p>
                {/if}
                <div class="form-group">
                    ...
                    <div class="input-group">
                    <a href="{$base_url}nhapkho.xls">Tải mẫu</a>
                    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        {$i=1}
                        {foreach $inhistory as $obj}
                        <tr align="center">
                            <td>{$i++}</td>
                            <td>{$obj->date|date_format:"d/m/Y"}</td>
                            <td>{$obj->time}</td>
                            <td>{$obj->reason_id}</td>
                            <td><a href="{$base_url}warehouse/inventory/{$obj->warehouse_id}">{$obj->warehouse_id}</a></td>
