...
{foreach $basket as $bk}
<div class="modal fade" id="update{$bk->basket_id}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" name="updatebasket" action="{$base_url}basket/update">
        <input type="hidden" name="old_basket_id" value="{$bk->basket_id}">
        <div class="modal-body">
          <div class="form-group row">
            <label for="new_basket_id" class="col-sm-2 col-form-label">Mã:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="new_basket_id" name="new_basket_id" required maxlength="20" value="{$bk->basket_id}" {literal}pattern="[A-Za-z0-9+-_]{2,}"{/literal}>
            </div>
          </div>
