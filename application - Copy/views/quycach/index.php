      ...
      <form class="form-horizontal" method="post" name="updatequycach" action="{$base_url}quycach/update">
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="new_quycach_id" name="new_quycach_id" required maxlength="20" value="{$bk->quycach_id}" {literal}pattern="[A-Za-z0-9+-_]{2,}"{/literal}>
            </div>
          </div>
          <div class="form-group row">
            <label for="new_quycach_id" class="col-sm-2 col-form-label">Tên:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="quycach_name" name="quycach_name" required maxlength="20" value="{$bk->quycach_name}">
            </div>
          </div>
          <div class="form-group row">
