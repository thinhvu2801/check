<div class="row">
  <div class="col-md-3">
    <div class="card card-info">
      ...
      <form action="{$base_url}phupham/insert" method="post">
        ...
        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          {foreach $product as $pr}
            <tr align="center">
              ...
              <td>
                <a href="{$base_url}phupham/card/{$pr->product_id}">
                ...
                {if $pr->has_child eq ""}
                <a style="color: #da251d" href="{$base_url}phupham/delete/{$pr->product_id}/{$pr->parent_id}" onclick="return confirm('Bạn có chắc chắn xóa không?');">
...
<div class="modal fade" id="update{$pr->product_id}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" name="updateproduct" action="{$base_url}phupham/update">
        <input type="hidden" name="parent_id" value="{$parent_id}">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            <label for="product_name" class="col-sm-2 col-form-label">Tên:</label>
            <div class="col-sm-10">
          ...
          <div class="form-group row">
            <label for="linkable" class="col-sm-2 col-form-label">Liên kết:</label>
            <div class="col-sm-10">
