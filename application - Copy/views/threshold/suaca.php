<div class="row">
    <div class="col-md-3">
        <div class="card card-info">
            ...
            <form action="{$base_url}threshold/suaca_read" method="post" id="form">
                <div class="card-body">
                    <!-- Date and time range -->
                    ...
                    <div class="form-group">
                        <!-- <div class="input-group">
                            ...
                            <input type="number" name="weight_in" value="{$weight_in}" step="0.001"
                                class="form-control">
                        </div> -->
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <button type="submit" class="btn btn-info btn-sm btn-block" name="select">Chọn</button>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                <form method="post" name="product_threshold" action="{$base_url}threshold/update">
                    ...
                    <input type="hidden" name="lo_id_selected" value="{$lo_id}">
                    <input type="hidden" name="option" value="suaca">
                        ...
                        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr style="font-weight: bold;" align="center">
                                    ...
                                    <td>Sản phẩm</td>
                                    <td>Định mức gợi ý</td>
                                    <td width="20%">Định mức cài đặt</td>
                                </tr>
                            </thead>
                            <tbody>
                                {$i=1}
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <input type="hidden" name="lo_id[]" value="{$rs->lo_id}">
                                        <input type="hidden" name="product_id[]" value="{$rs->product_id}">
                                        <input type="number" class="form-control float-right" name="threshold[]" step="0.001" 
                    ...
                    <button type="submit" class="btn btn-info btn-sm btn-block" name="update">Cập nhật</button>
                    {/if} -->
